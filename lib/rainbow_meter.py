...
class Rainbow_Meter:
    ...
    def check_result_already_exist(self):
        path_result = folder_result+folder_language_scenario+self.model.model_name 
    ...
    def get_answers(self):
        ...
        for prompt_type in prompt_types:
            ...
            for criteria in tqdm(self.criteria_list):        
                ...
                attempt = 0
                prompt = self.country.get_standard_prompt(criteria[prompt_type])
                ...
                while attempt < NUM_ATTEMPT and len(risp[prompt_type]) < NUM_ANSWERS: 
                    ...
                    clean_response = self.country.check_response(response)
                    ...
                    if clean_response != None: #Response is valid
                        ...
                        attempt += 1
                        prompt = self.country.get_retry_prompt(criteria[prompt_type], prompt + "\n" + str(response))
